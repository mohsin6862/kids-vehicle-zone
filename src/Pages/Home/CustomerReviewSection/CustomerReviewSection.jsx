...
const CustomerReviewSection = () => {
  const reviews = [
    ...
    },
    {
      id: 3,
      name: 'David Johnson',
      review: 'To be honest this is the best platform i have ever seen in my life. This is the best platform for the kids vehicle' ,
      rating: 4.5,
    },
  ];
            ...
            <div key={review.id} className="bg-white rounded-lg p-6 shadow-lg">
              <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="flex items-center mt-1">
                      {Array.from({ length: 5 }).map((_, index) => (
                        <RiStarFill
                          key={index}
                          className={`h-5 w-5 text-yellow-500 ${index < review.rating ? 'text-yellow-500' : 'text-gray-300'}`}
                        />
                      ))}
                ...
                <div className="text-gray-500">
                  <span className="text-xs">Review ID: {review.id}</span>
                </div>
              </div>
